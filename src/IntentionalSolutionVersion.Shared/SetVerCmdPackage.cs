...
namespace IntentionalSolutionVersion
{
	...
	/// defined in the framework to register itself and its components with the shell. These attributes tell the pkgdef creation utility what
	...
	[InstalledProductRegistration("#110", "#112", "1.0.8", IconResourceID = 400)] // Info on this package for Help/About
