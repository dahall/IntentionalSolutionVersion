namespace IntentionalSolutionVersion
{
	partial class VersionDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.newVerPanel = new System.Windows.Forms.TableLayoutPanel();
			this.label1 = new System.Windows.Forms.Label();
			this.newVerEdit = new IntentionalSolutionVersion.VersionEdit();
			this.showRevCheckBox = new System.Windows.Forms.CheckBox();
			this.showSufCheckBox = new System.Windows.Forms.CheckBox();
			...
			this.includeWithoutVer = new System.Windows.Forms.CheckBox();
			this.bodyPanel.SuspendLayout();
			this.flowLayoutPanel1.SuspendLayout();
			this.tableLayoutPanel2.SuspendLayout();
			this.newVerPanel.SuspendLayout();
			...
			this.bodyPanel.Controls.Add(this.newVerPanel, 1, 0);
			...
			// newVerPanel
			// 
			resources.ApplyResources(this.newVerPanel, "newVerPanel");
			this.newVerPanel.Controls.Add(this.label1, 0, 0);
			this.newVerPanel.Controls.Add(this.newVerEdit, 0, 1);
			this.newVerPanel.Controls.Add(this.showRevCheckBox, 0, 2);
			this.newVerPanel.Controls.Add(this.showSufCheckBox, 0, 3);
			this.newVerPanel.Name = "newVerPanel";
			// 
			// label1
			// 
			...
			// showRevCheckBox
			// 
			resources.ApplyResources(this.showRevCheckBox, "showRevCheckBox");
			this.showRevCheckBox.Checked = global::IntentionalSolutionVersion.Properties.Settings.Default.ShowRev;
			this.showRevCheckBox.DataBindings.Add(new System.Windows.Forms.Binding("Checked", global::IntentionalSolutionVersion.Properties.Settings.Default, "ShowRev", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
			this.showRevCheckBox.Name = "showRevCheckBox";
			this.showRevCheckBox.UseVisualStyleBackColor = true;
			this.showRevCheckBox.CheckedChanged += new System.EventHandler(this.showRevCheckBox_CheckedChanged);
			// 
			// showSufCheckBox
			// 
			resources.ApplyResources(this.showSufCheckBox, "showSufCheckBox");
			this.showSufCheckBox.Checked = global::IntentionalSolutionVersion.Properties.Settings.Default.ShowSuf;
			this.showSufCheckBox.DataBindings.Add(new System.Windows.Forms.Binding("Checked", global::IntentionalSolutionVersion.Properties.Settings.Default, "ShowSuf", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
			this.showSufCheckBox.Name = "showSufCheckBox";
			this.showSufCheckBox.UseVisualStyleBackColor = true;
			this.showSufCheckBox.CheckedChanged += new System.EventHandler(this.showSufCheckBox_CheckedChanged);
			// 
			// listCtxMenu
			// 
			...
			this.commandPanel.SetColumnSpan(this.borderPanel, 3);
			...
			this.commandPanel.Controls.Add(this.cancelBtn, 2, 1);
			this.commandPanel.Controls.Add(this.borderPanel, 0, 0);
			this.commandPanel.Controls.Add(this.okBtn, 1, 1);
			this.commandPanel.Controls.Add(this.panel1, 0, 1);
			this.commandPanel.Name = "commandPanel";
			// 
			// panel1
			// 
			this.panel1.Controls.Add(this.includeWithoutVer);
			resources.ApplyResources(this.panel1, "panel1");
			this.panel1.Name = "panel1";
			// 
			// includeWithoutVer
			// 
			resources.ApplyResources(this.includeWithoutVer, "includeWithoutVer");
			this.includeWithoutVer.Checked = global::IntentionalSolutionVersion.Properties.Settings.Default.InclPrjNoVer;
			this.includeWithoutVer.CheckState = System.Windows.Forms.CheckState.Checked;
			this.includeWithoutVer.DataBindings.Add(new System.Windows.Forms.Binding("Checked", global::IntentionalSolutionVersion.Properties.Settings.Default, "InclPrjNoVer", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
			this.includeWithoutVer.Name = "includeWithoutVer";
			this.includeWithoutVer.UseVisualStyleBackColor = true;
			this.includeWithoutVer.CheckedChanged += new System.EventHandler(this.includeWithoutVer_CheckedChanged);
			// 
			// VersionDialog
			// 
			...
			this.newVerPanel.ResumeLayout(false);
			this.newVerPanel.PerformLayout();
		...
		private System.Windows.Forms.TableLayoutPanel newVerPanel;
        ...
        private System.Windows.Forms.CheckBox includeWithoutVer;
		private System.Windows.Forms.CheckBox showRevCheckBox;
		private System.Windows.Forms.CheckBox showSufCheckBox;
	}
}
